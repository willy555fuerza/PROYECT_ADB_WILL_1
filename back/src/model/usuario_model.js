...
class Usersmodel {
    ...
    static async updateUser(id_usuario, nombres, apellidos, perfil, usuario, fecha_registro) {
        let pool;
        try {
            // Conectar a la base de datos
            pool = await connectToMssql();
            ...
            const query = `UPDATE usuario SET nombres = '${nombres}', apellidos = '${apellidos}', perfil = '${perfil}', usuario = '${usuario}', fecha_registro = '${fecha_registro}' WHERE id_usuario = ${id_usuario}`;
