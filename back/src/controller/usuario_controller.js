...
class Users{
    ...
    static async updateUser(req, res) {
        try {
            ...
            const { nombres, apellidos, perfil, usuario,  fecha_registro} = req.body;
    
            // Llamar al método para actualizar el usuario en el modelo
            const result = await Usersmodel.updateUser(id_usuario, nombres, apellidos, perfil, usuario,  fecha_registro);
